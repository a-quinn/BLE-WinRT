...
int main()
{
	...
	ScanCharacteristics(device.id, (wchar_t*)serviceUuid.c_str());
	...
	bool subOk = SubscribeCharacteristic(device.id, (wchar_t*)serviceUuid.c_str(), (wchar_t*)charUuidToSubscribe.c_str(), true);
	if (!subOk) {
