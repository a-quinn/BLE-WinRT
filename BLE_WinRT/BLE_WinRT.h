...
extern "C" {
	...
	__declspec(dllexport) bool UnsubscribeCharacteristic(wchar_t* deviceId, wchar_t* serviceId, wchar_t* characteristicId, bool block);
	__declspec(dllexport) bool TriggerCharacteristicRead(wchar_t* deviceId, wchar_t* serviceId, wchar_t* characteristicId, bool block);
	__declspec(dllexport) bool ReadCharacteristic(wchar_t* deviceId, wchar_t* serviceId, wchar_t* characteristicId, BLEData* data, bool block);
    __declspec(dllexport) bool PollData(BLEData* data, bool block);
	__declspec(dllexport) bool SendData(BLEData* data, bool block);
	__declspec(dllexport) void ClearCache(bool onlyServices = false);
